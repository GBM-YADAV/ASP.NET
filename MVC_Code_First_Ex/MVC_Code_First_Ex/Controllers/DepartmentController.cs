...
namespace MVC_Code_First_Ex.Controllers
{
    public class DepartmentController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DepId,DepName,Location")] Department department)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DepId,DepName,Location")] Department department)
        {
